...
const columns: any[] = [
  ...
  { header: "Service Performed", accessor: "service" },
  {
    header: "Cost",
    accessor: (row: any) => (
      <Text fontWeight="700">{formatCurrency(row.cost)}</Text>
    ),
  },
    ...
    <Box>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Fleet", href: "/business/fleet" },
          {
            ...
            href: "/business/vehicle_service_record",
          },
        ]}
      ...
      <SimpleGrid columns={[1, 2, 4]} spacing={6} mb={10}>
        ...
        >
          ...
          <Heading fontSize="28px" fontWeight="800" color={tokens.accent}>
            {formatCurrency(4200)}
          </Heading>
        </Box>
        <Box
        ...
        >
          ...
          <Heading fontSize="28px" fontWeight="800" color={tokens.warning}>
            5
          </Heading>
        </Box>
        <Box
        ...
        >
          ...
          <Heading fontSize="28px" fontWeight="800" color="emerald.500">
            96.5%
          </Heading>
        </Box>
      </SimpleGrid>
        ...
        <Flex justify="space-between" align="center" mb={8}>
          <Box>
            <Heading fontSize="18px" fontWeight="700">
              Detailed Service Ledger
            </Heading>
            <Text fontSize="13px" color={tokens.textMuted}>
              Filter by vehicle or technician for specific logs
            </Text>
          </Box>
          <HStack spacing={2}>
