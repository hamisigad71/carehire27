...
const OFFERS = [
  {
    ...
    img: "https://i.pinimg.com/1200x/08/77/5e/08775e7babac623e9e64fec0c307b1be.jpg",
    tag: "Seasonal",
    scheme: "blue",
  ...
  },
  {
    ...
    img: "https://i.pinimg.com/736x/9d/0c/64/9d0c6435dca068b8b0fa399af0ecfc81.jpg",
    tag: "Upgrade",
    scheme: "purple",
...
const BENEFITS = [
  {
    ...
    detail: "First pick on new additions — before public release.",
    color: T.gold,
  },
  {
    icon: FiShield,
    title: "Zero Security Deposit",
    detail: "Gold & Platinum members skip the deposit entirely.",
    color: T.accentBright,
  },
  {
    icon: FiZap,
    title: "Instant Approval",
    detail: "Verified members bypass the queue, every time.",
    color: "#60a5fa",
  },
  {
    icon: FiGift,
    title: "Birthday Surprise",
    detail: "A free day's rental on your birthday, every year.",
    color: "#f472b6",
  },
];
...
const TIERS = [
  {
    ...
    pts: "0–999",
    color: "#9ca3af",
    perks: ["5% off rentals", "Newsletter deals"],
  },
  {
    name: "Gold",
    pts: "1000–2499",
    color: T.gold,
    perks: ["10% off", "Zero deposit", "Priority booking"],
  },
  {
    name: "Platinum",
    pts: "2500+",
    color: "#e2e8f0",
    perks: ["20% off", "Free chauffeur", "Lounge access", "Birthday rental"],
  },
];
...
function CodeBox({ code, T }: { code: string; T: TokenType }) {
  ...
  return (
    ...
    >
      ...
      <Circle
        size="32px"
        bg={copied ? T.accentGlow : T.accentGlow2}
        border="1px solid"
        borderColor={T.cardBorder}
        flexShrink={0}
      >
        <Icon
          ...
          boxSize={3.5}
          color={copied ? T.accentBright : T.muted}
        />
      </Circle>
    </Flex>
  );
    ...
    >
      ...
      >
        ...
        <Circle
          size="140px"
          border="1px dashed"
          borderColor="rgba(45,125,45,0.2)"
          position="absolute"
          top="20px"
          left="20px"
        />
      ...
      <Container maxW="1200px" position="relative" zIndex={2}>
        ...
        >
          ...
          >
            ...
            <Heading
              className="fu1"
              fontSize={{ base: "34px", md: "58px", lg: "68px" }}
              fontWeight="800"
              lineHeight="1.05"
            ...
            <Text
              ...
              textAlign={{ base: "center", lg: "left" }}
            >
              Discover offers designed for our most valued clients — from
              seasonal discounts to loyalty rewards that grow with every
              journey.
            </Text>
            ...
            <HStack className="fu4" spacing={8} pt={2}>
              {(
                ...
                <Box key={l}>
                  ...
                  <Text fontSize="11px" color={T.subtle} fontWeight="500">
                    {l}
                  </Text>
                </Box>
              ))}
          ...
          >
            ...
            <Box
              ...
              boxShadow="xl"
            >
              <Text fontSize="11px" color={T.subtle} fontWeight="600" mb="2px">
                THIS MONTH
              </Text>
              <Text
                fontSize="26px"
  ...
  return (
    <Container maxW="1200px" mt="-60px" position="relative" zIndex={10}>
      ...
      >
        ...
        <Box
          h="3px"
          bgGradient="linear(90deg, #154a15, #4a9e4a, #72b872, #4a9e4a, #154a15)"
        />
            ...
            <HStack mb={{ base: 4, md: 6 }} spacing={3} flexWrap="wrap">
              ...
              <HStack spacing={1.5}>
                <Box
                  ...
                  bg={T.danger}
                />
                <Text fontSize="12px" fontWeight="600" color={T.danger}>
                  ENDS SOON
                </Text>
              </HStack>
            </HStack>
...
function OfferCard({
  ...
  const sc =
    SCHEME_MAP[offer.scheme as keyof typeof SCHEME_MAP] || SCHEME_MAP.green;
  return (
    <Box
    ...
    >
      ...
      <Box h="220px" overflow="hidden" position="relative">
        ...
        <Box position="absolute" bottom={4} left={4}>
          <Text fontSize="11px" fontWeight="600" color="rgba(255,255,255,0.6)">
            {offer.saving}
          </Text>
        </Box>
      </Box>
...
function LoyaltySection({ T }: { T: TokenType }) {
  return (
    ...
    >
      ...
      <Box
        h="3px"
        bgGradient="linear(90deg, transparent, #d4a843, #f5d680, #d4a843, transparent)"
      />
          ...
          <VStack align="start" spacing={8}>
            <Box>
              ...
              >
                ...
                <Text
                  as="span"
                  bgGradient="linear(135deg, #d4a843, #f5d680)"
                  bgClip="text"
                >
                  Elite Rewards
                </Text>
              ...
              <Text
                ...
                fontWeight="300"
              >
                Every kilometre earns you more. Your loyalty unlocks a world of
                exclusive benefits — from zero deposits to complimentary
                upgrades and birthday surprises.
              </Text>
            </Box>
            ...
            <Box position="relative">
              ...
              >
                ...
                <Box
                  position="absolute"
                  inset={0}
                  bg="linear-gradient(180deg, transparent 40%, rgba(17,24,17,0.85) 100%)"
                  borderRadius="32px"
                />
              </Box>
          ...
          <VStack spacing={16} align="stretch">
            ...
            <Box>
              ...
              <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={6}>
                {OFFERS.map((offer, i) => (
                  <OfferCard key={i} offer={offer} index={i} T={T} />
                ))}
              </SimpleGrid>
            </Box>
